...
public class TestMap {
    ...
    public void test6() throws Exception {
        ...
        paramMap.put("AuthType", "APP");
        paramMap.put("User", "testKey");
        paramMap.put("Secret", "ad6d5887-bb54-11e6-849c-4846fbf86bcb");
        String fileComments = "download resource file";

        fileComments = URLEncoder.encode(fileComments, "utf8");

        paramMap.put("FileComments", fileComments);
        paramMap.put("TemplateId", "");
        paramMap.put("IsTextFile", "0");
        paramMap.put("Charset", "UTF-8");
        paramMap.put("CsvSeparator", "");
        paramMap.put("ToMembers", Lists.newArrayList(1234,"wb-tt861376"));
